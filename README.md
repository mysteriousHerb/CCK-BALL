...
2. Let github action compile the firmware.
3. Push the microcontroller button twice and drag and drop the reset firmware and then the left and right hand firmware
